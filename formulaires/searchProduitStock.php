...
include 'functionsFormulaire.php';
 ?>
 <article>
   <h3>Gestion du stock des Produits </h3>
<p>Recherche d'un produit par son nom (utiliser %lettre% pour filtrer) pour gérer son stock :
</p>
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  foreach ($dataTraiter as $key) {
    ...
    echo   '<tr>
        ...
        <td>'.$stockage.'</td>
        <td>
          <form class="" action="editStock.php" method="post" enctype="multipart/form-data">
